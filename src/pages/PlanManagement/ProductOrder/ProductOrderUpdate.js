...
@Form.create()
class ProductOrderUpdate extends PureComponent {
  state = {
    TableWorkData:[],
    SelectWorkValue:[],
    selectedWorkRowKeys:[],
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.data.record !== this.props.data.record){
      ...
      this.setState({
        initData,
        selectedWorkRowKeys:[initData.workCenterId],
        selectedWorkValue:initData.workCenterName,
        selectedMaterialRowKeys:[initData.materialBaseId],
        selectedMaterialValue:initData.materialName,
        selectedPersonRowKeys:[initData.billMakerId],
        selectedPersonValue:initData.billMakerName
      })
    }
  }
  ...
  onSave = (onSave)=>{
    ...
    const { initData,selectedWorkRowKeys,selectedMaterialRowKeys,selectedPersonRowKeys,BStatus } = this.state;
    if(BStatus){
      return
    }
        ...
        <Row gutter={16}>
          <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="订单编码">
              ...
              })(<Input placeholder="请输入订单编码" disabled/>)}
            </Form.Item>
          </Col>
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="物料编码">
              {getFieldDecorator('materialName', {
               ...
               initialValue:initData.materialName
              })(
          ...
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="订单数量">
              {getFieldDecorator('orderNum',{
                rules: [{required: true}],
                initialValue:initData.orderNum
              })(<Input placeholder="请输入订单数量" type={'Number'} disabled/>)}
            </Form.Item>
          </Col>
        </Row>
        <Row gutter={16}>
          <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="完工数量">
              {getFieldDecorator('finishNum', {
                initialValue:initData.finishNum
              })(<Input placeholder="请输入完工数量" type={'Number'} disabled/>)}
            </Form.Item>
          </Col>
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="计划开工时间">
              {getFieldDecorator('planStartTime', {
                rules: [{required: true}],
                initialValue:initData.planStartTime?moment(initData.planStartTime):null
          ...
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="计划完工时间">
              {getFieldDecorator('planEndTime', {
                rules: [{required: true}],
                initialValue:initData.planEndTime?moment(initData.planEndTime):null
              })(<DatePicker  style={{width:'100%'}} disabled/>)}
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="实际开工时间">
              {getFieldDecorator('actStartTime', {
                initialValue:initData.actStartTime?moment(initData.actStartTime):null
              })(<DatePicker  style={{width:'100%'}} disabled/>)}
            </Form.Item>
          </Col>
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="实际完工时间">
              {getFieldDecorator('actEndTime', {
                initialValue:initData.actEndTime?moment(initData.actEndTime):null
              })(<DatePicker  style={{width:'100%'}} disabled/>)}
            </Form.Item>
          </Col>
        </Row>
          ...
          <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="制单人">
              {getFieldDecorator('billMakerName',{
                ...
                initialValue:initData.billMakerName
              })(
                <Input disabled/>
              // <TreeTable
              //   on={personOn}
          ...
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="订单创建日期">
              {getFieldDecorator('createDate', {
                initialValue:initData.createDate?moment(initData.createDate):null
              })(<DatePicker  style={{width:'100%'}} disabled/>)}
            </Form.Item>
          </Col>
          <Col lg={{ span: 6, offset: 2 }} md={{ span: 10, offset: 1 }} sm={24}>
            <Form.Item label="订单状态">
              {getFieldDecorator('orderStatus', {
                initialValue:0
              })( <Select style={{width:'100%'}} placeholder="请选择订单状态" disabled>
        ...
        <Row gutter={16}>
         <Col lg={{ span: 22, offset: 1 }} md={{ span: 22, offset: 1 }} sm={24}>
            <Form.Item label="备注">
              ...
              })(<TextArea rows={3} disabled placeholder={'请输入备注'}/>)}
            </Form.Item>
          </Col>
        </Row>
      </Modal>
