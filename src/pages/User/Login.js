...
import backgroundImgcc from '@/assets/cc.jpg';
import backgroundImgdd from '@/assets/dd.jpg';
    ...
    return (
      <DocumentTitle title="">
        <div className={styles.login} style={{
          background: `url(${backgroundImgdd}) 0/100% 58% no-repeat`,
