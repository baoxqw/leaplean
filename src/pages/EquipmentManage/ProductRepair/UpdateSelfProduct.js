...
@Form.create()
class UpdateSelfProduct extends PureComponent {
  state = {
    TableHitchData:[],//故障类型
    SelectHitchValue:[],
  ...
  componentDidMount(){
    ...
    const { initdate } = data
    const faultTypeId = initdate.faultTypeId
    const faultTypeName = initdate.faultTypeName

    const personId = initdate.personId;
    const personName = initdate.personName;

    this.setState({
      SelectOperationValue:personName,
      selectedOperationRowKeys:[personId],
      selectedHitchRowKeys:[faultTypeId],
      SelectHitchValue:faultTypeName,
    })
  }
  ...
  handleOk = (onOk) =>{
    ...
    form.validateFieldsAndScroll((err, values) => {
      ...
      const obj ={
        ...
        application:values.application.format('YYYY-MM-DD'),
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <Form.Item label='申请时间'>
                {getFieldDecorator('application', {
                  initialValue:initdate?moment(initdate.application):null
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <Form.Item label='所属设备'>
                {getFieldDecorator('deviceId', {
                  initialValue:initdate?initdate.deviceId:'',
                  rules: [
                    {
                      required: true,
                      message:'请输入所属设备'
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <Form.Item label='维修人员'>
                {getFieldDecorator('serviceId', {
                  initialValue:initdate?initdate.serviceId:'',
                  rules: [
                    {
                      required: true,
                      message:'请选择维修人员'
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <Form.Item label='故障类型'>
                {getFieldDecorator('faultTypeId', {
                  initialValue:initdate?initdate.faultTypeId:'',
                  rules: [
                    {
                      required: true,
                      message:'请选择故障类型'
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <Form.Item label="申请人">
                {getFieldDecorator('personId',{
                  initialValue:initdate?initdate.personName:'',
                  rules: [{
                    required: true,
                    message:'请选择申请人'
                  }],
...
export default UpdateSelfProduct;
