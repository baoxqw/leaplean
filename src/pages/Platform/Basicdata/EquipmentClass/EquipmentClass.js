...
@connect(({ EC, loading }) => ({
  EC,
  loading: loading.models.EC,
}))
@Form.create()
class EquipmentClass extends PureComponent {
  state = {
    value: undefined,
    treeData:'',
    isdisabled:true,
    ...
    return (
      <PageHeaderWrapper>
        <div style={{display:'flex'}}>
          ...
          <Card title="设备分类" style={{ flex:'1',boxSizing:'border-box',overflow:'hodden' }} bordered={false}>
            <Form {...formItemLayout} layout="vertical"  onSubmit={this.handleSubmit}>
              <Form.Item label="设备分类编码：">
                ...
                })(<Input placeholder='请填写设备分类编码' disabled={isdisabled}/>)}
              </Form.Item>
              <Form.Item label="设备分类名称：">
                ...
                })(<Input placeholder='请填写设备分类名称' disabled={isdisabled}/>)}
              </Form.Item>
