...
@Form.create()
class CalendarRuleAdd extends PureComponent {
  state = {
    startValue: null,
    valueList:[
      {
  ...
  backClick =()=>{
    router.push('/platform/basicdata/calendarrule/list')
  }
  validate = ()=>{
...
export default CalendarRuleAdd;

=======
>>>>>>> 34cc13797eda3e0cac5061e7536847c9669c07c8
