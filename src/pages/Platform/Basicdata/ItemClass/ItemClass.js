    ...
    return (
      <PageHeaderWrapper>
        <div style={{display:'flex'}}>
          ...
          <Card title="物料分类" style={{ flex:'1',boxSizing:'border-box',overflow:'hodden' }} bordered={false}>
            <Form {...formItemLayout} layout="vertical"  onSubmit={this.handleSubmit}>
              <Form.Item label="物料分类编码：">
                ...
                })(<Input placeholder='请填写物料分类' disabled={isdisabled}/>)}
              </Form.Item>
              <Form.Item label="物料分类名称：">
                ...
                })(<Input placeholder='请填写物料分类名称' disabled={isdisabled}/>)}
              </Form.Item>
