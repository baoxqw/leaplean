...
import LicenseTableForm from './LicenseTableForm';
...
const financeTableData = [
  {
    ...
    financialyear: '2018',
    financialindex: '资产负债',
    financialindexdata: '10,000',
  },
  {
    key: '2',
    financialyear: '2018',
    financialindex: '税前利润',
    financialindexdata: '20,000',
  },
  {
    key: '3',
    financialyear: '2018',
    financialindex: '净利润',
    financialindexdata: '-2,000',
  },
];
...
const shareholderTableData = [
  {
    key: '1',
    shareholdertype: '创始团队',
    rate: '15%',
  },
  {
    key: '2',
    shareholdertype: '外部投资者',
    rate: '85%',
  },
  {
    key: '3',
    shareholdertype: '员工（尚未分配）',
    rate: '6%',
  },
];

const financingTableData = [
  {
    key: '1',
  ...
  {
    key: '2',
    investdate: '2018-06-01',
    rounds: 'B轮',
    investtype: 'Token',
    investor: 'A,C',
    investmount: '19,000,000',
    valuation: '190,000,000',
  },
  {
    key: '3',
    investdate: '2019-06-01',
    rounds: 'C轮',
    investtype: 'Token',
    investor: 'B,D',
    investmount: '2,000,000,000',
...
const licenseTableData = [
  {
    key: '1',
    licensename: 'MBS License',
    licensestat: '已获得',
    acquiredate: '',
  },
  {
    key: '2',
    licensename: 'BD License',
    licensestat: '未获得',
    acquiredate: '',
  },
  {
    key: '3',
    licensename: 'Banking License',
    licensestat: '申请中',
    acquiredate: '2019.11',
  },
];

const DistributionPlanTableData = [
  {
    key: '1',
    uses: '团队',
    rate: '15%',
...
@Form.create()
class CorpAdminAdds extends PureComponent {
  state = {
    width: '100%',
  ...
  submitContent2 = async () => {
    // 在编辑器获得焦点时按下ctrl+s会执行此方法
    // 编辑器内容提交到服务端之前，可直接调用editorState.toHTML()来获取HTML格式的内容
    const htmlContent = this.state.editorState2.toHTML();
    const result = await saveEditorContent(htmlContent);
  };
  ...
  render() {
    ...
    const { width, editorState, editorState1, editorState2,financeTableData } = this.state;
    ...
    return (
      <PageHeaderWrapper>
        <Row>
          <Col span={22}>
            <Form layout="vertical"  onChange={this.handleSearch}>
              <Card title="项目信息" className={styles.card} bordered={false} id='1'>
                  <Row gutter={16}>
                    ...
                    <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
                      <Form.Item label={fieldLabels.maininvestor}>
                        {getFieldDecorator('maininvestor', {
                          rules: [{ required: true, message: '请输入投资主体' }],
                  ...
                  <Row gutter={16}>
                    <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
                      <Form.Item label={fieldLabels.istoken}>
                    ...
                    <Col xl={{ span: 16, offset: 2 }} lg={{ span: 18 }} md={{ span: 12 }} sm={24}>
                      <Form.Item label={fieldLabels.address}>
                        {getFieldDecorator('address')(<Input placeholder="请输入公司地址" />)}
                      </Form.Item>
                    </Col>
                  </Row>
                  <Row gutter={16}>
                  ...
                  <Row gutter={16}>
                   <Col lg={{ span: 22, offset: 1 }} md={{ span: 22, offset: 1 }} sm={24}>
                      <Form.Item label={fieldLabels.subjectdesc}>
                        {getFieldDecorator('subjectdesc')(<TextArea />)}
                      </Form.Item>
                    </Col>
                  </Row>
              ...
              <Card title="公司财务" className={styles.card} bordered={false} id='5'>
                {getFieldDecorator('finance', {
                  initialValue: financeTableData,
                })(<FinanceTableForm/>)}
              </Card>

              <Card title="股东结构" className={styles.card} bordered={false} id='6'>
                {getFieldDecorator('shareholder', {
                  initialValue: shareholderTableData,
                })(<ShareholderTableForm />)}
              </Card>

              <Card title="融资历史" className={styles.card} bordered={false} id='7'>
                {getFieldDecorator('history', {
                  initialValue: financingTableData,
                })(<FinancingTableForm />)}
              </Card>

              <Card title="牌照信息" bordered={false} id='8'>
                {getFieldDecorator('licenseinfo', {
                  initialValue: licenseTableData,
                })(<LicenseTableForm />)}
              </Card>

              <Card title="分配方案" bordered={false} id='9'>
                {getFieldDecorator('distribution', {
                  initialValue: DistributionPlanTableData,
        ...
        <FooterToolbar style={{ width }}>
          {/* {this.getErrorInfo()} */}
          <Button type="primary" onOk={this.validate} loading={submitting}>
            提交
          </Button>
        </FooterToolbar>
      </PageHeaderWrapper>
