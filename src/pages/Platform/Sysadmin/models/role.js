import {
  queryRole, findRole, getRole, roleIdAntu, inputIndex,
  newdata, newregister, queryRoleForTable, Distribution,
  removenewdatamenu, findnewdata, removeRole, addRole,
  updateRole, fetchAntu
} from '@/services/api';
