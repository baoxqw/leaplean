...
@Form.create()
class BomChildCadd extends PureComponent {
  index = 0;
        ...
        render: (text, record) => {
          const on = {
            ...
            onOk:(selectedRowKeys,selectedRows)=>{
              ...
              this.handleFieldChange({selectedRowKeys:selectedRowKeys[0],materialname:nameList[0],ucumId,ucumname}, 'materialname', record.key)
            }, //模态框确定时触发
            onCancel:()=>{
