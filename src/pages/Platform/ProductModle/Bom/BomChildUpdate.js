...
@Form.create()
class BomChildUpdate extends PureComponent {
  state = {
    TableWorkData:[],
    SelectWorkValue:[],
    selectedWorkRowKeys:[],
  ...
  componentDidMount(){
    const initData = this.props.location.state.obj;
    if(!initData){
      return
    }
  ...
  validate = ()=>{
    ...
    form.validateFieldsAndScroll((err, values) => {
      ...
      const obj = {
        ...
        technologyId:this.state.initData.supId,
              ...
              <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
                <Form.Item label="装配位置">
                  {getFieldDecorator('zpwz', {
                    initialValue:initData.zpwz?initData.zpwz:'',
              ...
              <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
                <Form.Item label="装配提前期">
                  {getFieldDecorator('zptqq', {
                    initialValue:initData.zptqq?initData.zptqq:'',
