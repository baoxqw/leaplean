...
@Form.create()
class CopySuperAdd extends PureComponent {
  state = {
    materialBaseName: '',
    materialBaseId: null,
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.data.visible !== this.props.data.visible) {
      const initData = nextProps.data.addCopy;
      ...
      this.setState({
        initData,
        selectedOperationRowKeys: [initData.operationId],
        SelectOperationValue: initData.operatorname,
      });
    }
  }
  ...
  render() {
    ...
    const { version, initData, } = this.state;
