...
import { Table, Button,Checkbox,Select, Input, message, Popconfirm,Form, Divider, DatePicker } from 'antd';
...
@Form.create()
class RoutCadd extends PureComponent {
  index = 0;
