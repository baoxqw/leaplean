import { queryTaskId,fetchVerify ,queryScheme,fetchAdvice,
  detailcheck,submitCheck} from '@/services/WOC';
...
export default {
  ...
  effects: {
    ...
    *queryTaskId({ payload, callback }, { call, put }) {
      const response = yield call(queryTaskId, payload);
      if (callback) callback(response);
    },
