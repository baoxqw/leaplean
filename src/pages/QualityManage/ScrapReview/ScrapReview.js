...
@connect(({ Sreview, loading }) => ({
  ...
  loadingSuper: loading.effects['Sreview/fetchVerify'],
}))
@Form.create()
class ScrapReview extends PureComponent {
  state = {
    page:{
      pageSize:1000000,
      pageIndex:0
  ...
  checkRoute = (e,record)=>{
    e.preventDefault();
    router.push({
      pathname:'/qualitymanage/qualitissues/scrapreview/check',
      query:{
        ...record
      }
    })
  ...
  renderForm() {
    ...
    const datas = {
      ...
      title:'物料选择',
      tableType: 'Sreview/fetchMata',
      treeType: 'Sreview/matype',
      treeCode:'invclId',
        ...
        <Card bordered={false}>
          ...
          <div  style={{marginTop:'12px'}}>
            <NormalTable
              ...
              data={dataVerify}
              columns={columns}
              classNameSaveColumns={"QualitIssuesVerify"}
