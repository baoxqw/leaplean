...
@Form.create()
class UpdateSelfOver extends PureComponent {
  state = {
    initData:{},
    TreeMaterialData:[],//物料
    MaterialConditions:[],
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.data.record.id !== this.props.data.record.id){
      ...
      const senderId = initData.senderId;
      const senderName = initData.senderName;
      const materialId = initData.materialId;
      const materialName = initData.materialName;
      this.setState({
        initData:nextProps.data.record,
        SelectOperationValue:senderName,
        selectedOperationRowKeys:[senderId],
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='单据编码'>
                {getFieldDecorator('billcode',{
                  initialValue:initData.billcode?initData.billcode:'',
                })(<Input placeholder='请输入单据编码' disabled/>)}
              </FormItem>
            </Col>
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='送检人'>
                {getFieldDecorator('senderId',{
                  initialValue:initData.senderName?initData.senderName:'',
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='预期	'>
                {getFieldDecorator('expected',{
                  initialValue:initData.expected?initData.expected:'',
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='批号数量'>
                {getFieldDecorator('lotNumber',{
                  initialValue:initData.lotNumber?initData.lotNumber:'',
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='复验号'>
                {getFieldDecorator('recheckNumber',{
                  initialValue:initData.recheckNumber?initData.recheckNumber:'',
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='样本编号	'>
                {getFieldDecorator('sampleNumber',{
                  initialValue:initData.sampleNumber?initData.sampleNumber:'',
            ...
            <Col lg={{ span: 6, offset: 1 }} md={{ span: 10, offset: 1 }} sm={24}>
              <FormItem label='请求日期'>
                {getFieldDecorator('requestDate',{
                  initialValue:initData.requestDate?moment(initData.requestDate):null,
