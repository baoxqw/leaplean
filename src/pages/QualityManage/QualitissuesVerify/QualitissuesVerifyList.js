...
@connect(({ issues, loading }) => ({
  ...
  loadingSuper: loading.effects['issues/fetchVerify'],
}))
@Form.create()
class QualitIssuesVerifyList extends PureComponent {
  ...
  checkRoute = (e,record)=>{
    e.preventDefault();
    router.push({
      pathname:'/qualitymanage/qualitissues/qualitisverify/qualitissuescheck',
      query:{
        ...record
      }
    })
   // router.push("/qualitymanage/qualitisverify/qualitissuescheck",{record})
  }
