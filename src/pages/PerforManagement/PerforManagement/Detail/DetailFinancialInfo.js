...
@connect(({ finace,loading }) => ({
  finace,
  loading: loading.models.finace,
  datavale:finace.datasource,
  // submitting: loading.effects['form/submitProjectAddForm'],
}))

@Form.create()
class DetailFinancialInfo extends PureComponent {
        ...
        <GridContent>
          <Row gutter={24}>
            <Col style={{marginBottom:'40px'}}>
              <Card title={formatMessage({ id: 'validation.financialinformation' })} bordered={false}>
...
export default DetailFinancialInfo;
